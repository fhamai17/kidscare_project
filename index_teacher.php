            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-info font-weight-bold">แดชบอร์ด</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item">
                                    <a data-toggle="tab" class="nav-link" href="#leave"><i class="bi bi-envelope-fill"></i> ลาเรียน</a>
                                </li>
                                <li class="nav-item">
                                    <a data-toggle="tab" class="nav-link" href="#sdq"> <i class="bi bi-clipboard2-heart-fill"></i> SDQ</a>
                                </li>
                                <li class="nav-item">
                                    <a data-toggle="tab" class="nav-link" href="#home"><i class="bi bi-house-fill"></i> เยี่ยมบ้าน</a>
                                </li>
                            </ul>
                            <!-- Tab panes -->
