                ...
                echo '<tr>' .
                    ...
                    '<td>             
                       '.$status.'
                        ...
                        '<td>             
                        <button class="badge badge-success" onclick="approveParent('.$row['parent_id'].',1)">
                            <span class="icon">
                            <i class="fa fa-check"></i>
                            </span>อนุมัติ
                        </button>
                        <button class="badge badge-danger" onclick="approveParent('.$row['parent_id'].',0)"><span class="icon">
