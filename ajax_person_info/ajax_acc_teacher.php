...
<div class="table-responsive">
    <table class="table table-hover  responsive" id="teacherDataTable" width="100%" cellspacing="0">
        <thead>
            <tr>
                <th>ID</th>
                <th>ชื่อ</th>
                ...
                echo '<tr>' .
                    ...
                    '<td>             
                       '.$status.'
                        ...
                        '<td>             
                        <button class="badge badge-success" onclick="approveTeacher('.$row['teacher_id'].',1)">
                            <span class="icon">
                            <i class="fa fa-check"></i>
                            </span>อนุมัติ
                        </button>
                        <button class="badge badge-danger" onclick="approveTeacher('.$row['teacher_id'].',0)"><span class="icon">
...
<script>
    function approveTeacher(id,num){
        Swal.fire({
