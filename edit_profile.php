...
<head>
    <title>KidsCare - แก้ไขข้อมูลส่วนตัว</title>
    <style>
        .center {
            height: 100%;
            display: flex;
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <form id="personForm" enctype="multipart/form-data" autocomplete="off">
                        <div class="card shadow mb-4">
                            <div class="card-header d-flex justify-content-center align-items-center py-3">
                                <h6 class="m-0 font-weight-bold text-info text-center">แก้ไขข้อมูลส่วนตัวของฉัน</h6>
                            </div>
                            <div class="card-body pl-5 pr-5">
                                        ...
                                        <?php if($user_type === "ผู้ปกครอง"){?>
                                            ...
                                            <div class="form-group col-sm-6 ">
                                                ...
                                                <div class="input-group ">
                                                    ...
                                                    <input type="text" class="form-control " name="career" id="career" placeholder="โปรดระบุอาชีพ">
                                                </div>
                                            </div>

                                            <div class="form-group col-sm-6 ">
                                                <label for="validationServer01" class="form-label">รายได้ต่อเดือน</label>
                                                <div class="input-group ">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><i class="bi bi-cash-coin"></i></span>
                                                    </div>
                                                    <input type="number" class="form-control " name="salary" id="salary" min="0" placeholder="โปรดระบุรายได้ (เดือน)">
                                                </div>
                                            </div>
                                            <?php }?>
                                ...
                                ?>
                                    ...
                                    <div class="form-group col-sm-4 ">
                                        ...
                                        <select class="form-control selectpicker" name="type" id="type" data-size="5" data-live-search="true" disabled>
...
?>
    ...
    <script>
        ...
        function showPersonInfo() {
            if (type === "ผู้ปกครอง") {
                $("#user_id").attr('name', 'parent_id');
                url = 'ajax_person_info/ajax_parent_update.php';
                showParentInfo();
            } else {
                $("#user_id").attr('name', 'personnel_id');
        ...
        function getZipcode() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#zipcode').val(data);
                    $("#personForm").bootstrapValidator('revalidateField', 'zipcode');
                }
            });
        ...
        $('#personForm').bootstrapValidator({
            ...
            // Prevent submit form
            $('#personForm').data('bootstrapValidator').resetForm();
            e.preventDefault();
            if (id) {
                updatePersonnel();
            } else {
            ...
            $('#personForm button[type="submit"]').attr('disabled', !formIsValid);
        });
        ...
        function updatePersonnel() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    let formData = new FormData($("#personForm")[0]);
