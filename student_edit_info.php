...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header d-flex justify-content-center align-items-center py-3">
                            <h6 class="m-0 font-weight-bold text-info" id="topic_std">ข้อมูลนักเรียน</h6>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="nav nav-tabs mb-3" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#menu2" id="tab_two"><i class="bi bi-2-circle-fill"></i> ข้อมูลผู้ปกครอง</a>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="tab-pane active " id="menu1">
                                            <form id="studentForm" autocomplete="off">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-sm-4 ">
                                                                ...
                                                                <div class="input-group ">
                                                                    ...
                                                                    <input type="text" class="form-control " name="national" id="national" placeholder="โปรดระบุสัญชาติ">
                                                                </div>
                                                            </div>
                                                            <div class="form-group col-sm-4 ">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-sm-3  ">
                                                                ...
                                                                <div class="input-group ">
                                                                    ...
                                                                    <select class="form-control selectpicker" name="std_province" id="std_province" data-size="5" data-live-search="true" onchange="getDistrictList(null,null,'std')">
                                                            ...
                                                            <div class="form-group col-sm-3 ">
                                                                ...
                                                                <div class="input-group ">
                                                                    ...
                                                                    <select class="form-control selectpicker" name="std_district" id="std_district" data-size="5" data-live-search="true" onchange="getSubDistrictList(null,null,'std')">
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <button class="btn btn-sky" type="submit">บันทึกข้อมูลส่วนตัวนักเรียน</button>
                                                </div>
                                            </form>
                                        </div><!-- /.tab-panet menu1 -->
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-sm-3 ">
                                                                ...
                                                                <div class="input-group ">
                                                                    ...
                                                                    <select class="form-control selectpicker" name="fa_province" id="fa_province" data-size="5" data-live-search="true" onchange="getDistrictList(null,null,'fa')">
                                                            ...
                                                            <div class="form-group form-group col-sm-3 ">
                                                                ...
                                                                <div class="input-group ">
                                                                    ...
                                                                    <select class="form-control selectpicker" name="fa_district" id="fa_district" data-size="5" data-live-search="true" onchange="getSubDistrictList(null,null,'fa')">
                                                                        <option value="" disabled selected>-โปรดเลือกอำเภอ-</option>
                                                                    </select>
                                                                </div>
                                                            </div>
    ...
    <script>
        ...
        function showStudentInfo() {
            $.ajax({
                type: 'POST',
                url: 'ajax_person_info/ajax_std_detail.php',
                data: {
                    id
                },
                success: function(data) {
                    ...
                    if (obj.pic) {
                        $('#file_preview').attr("src", 'uploads/student_pics/' + obj.pic);
                    }
                    $('#topic_std').html('ข้อมูลนักเรียน #'+obj.student_id+" "+obj.pname+obj.fname+" "+obj.lname);
                    $('#student_id').val(obj.student_id);
                    $('#idcard').val(obj.card_id);
                    $('#pname').val(obj.pname);
                    ...
                    $('#std_address').val(obj.address);
                    $('#std_zipcode').val(obj.zipcode);
                    $('#std_grade').val(obj.grade_id);
                    $('#std_status').val(obj.status);
                    showProvinceList(obj.province, 'std');
                    getDistrictList(obj.province, obj.district, 'std');
                    getSubDistrictList(obj.district, obj.sub_district, 'std');

                    $('#fa_pname').val(obj.fa_pname);
                    $('#fa_fname').val(obj.fa_fname);
                    $('#fa_lname').val(obj.fa_lname);
                    $('#fa_address').val(obj.fa_address);
                    $('#fa_zipcode').val(obj.fa_zipcode);
                    $('#fa_career').val(obj.fa_career);
                    $('#fa_salary').val(obj.fa_salary);
                    $('#fa_email').val(obj.fa_email);
                    $('#fa_phone').val(obj.fa_phone);
                    showProvinceList(obj.fa_province, 'fa');
                    getDistrictList(obj.fa_province, obj.fa_district, 'fa');
                    getSubDistrictList(obj.fa_district, obj.fa_subdistrict, 'fa');

                    $('#mo_pname').val(obj.mo_pname);
                    $('#mo_fname').val(obj.mo_fname);
                    $('#mo_lname').val(obj.mo_lname);
                    $('#mo_address').val(obj.mo_address);
                    $('#mo_zipcode').val(obj.mo_zipcode);
                    $('#mo_career').val(obj.mo_career);
                    $('#mo_salary').val(obj.mo_salary);
                    $('#mo_email').val(obj.mo_email);
                    $('#mo_phone').val(obj.mo_phone);
                    showProvinceList(obj.mo_province, 'mo');
                    getDistrictList(obj.mo_province, obj.mo_district, 'mo');
                    getSubDistrictList(obj.mo_district, obj.mo_subdistrict, 'mo');
        ...
        function showProvinceList(province_id, text) {
            $.ajax({
                type: 'POST',
        ...
        function getDistrictList(province_id, district_id, text) {
            var id = $('#' + text + '_province').val();
            if (!id) {
                id = province_id;
            }
            $.ajax({
        ...
        function getSubDistrictList(district_id, subdistrict_id, text) {
            var id = $('#' + text + '_district').val();
            if (!id) {
                id = district_id;
            }
        ...
        Swal.fire({
                title: "แก้ไขข้อมูล"+$("#pname").val()+$("#fname").val()+" "+$("#lname").val(),
                text: "คุณต้องการยืนยันแก้ไขข้อมูลนักเรียนคนนี้หรือไม่?",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'ajax_person_info/ajax_std_updateStd.php',
                        data: formData,
                        processData: false,
                        contentType: false,
                        success: function(res) {
                            console.log("Std Update : " + res);
                           if (res.search("Update Successful") != -1) {
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'แก้ไขข้อมูลนักเรียนไม่สำเร็จ!',
        ...
        function updateParentForm(){
            Swal.fire({
                title: "แก้ไขข้อมูลผู้ปกครองของ"+$("#pname").val()+$("#fname").val()+" "+$("#lname").val(),
                text: "คุณต้องการแก้ไขข้อมูลผู้ปกครองของนักเรียนคนนี้หรือไม่?",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'ajax_person_info/ajax_std_updateParent.php',
                        data: formData,
                        processData: false,
                        contentType: false,
                        success: function(res) {
                           ...
                           if (res.search("Update Successful") != -1) {
                                Swal.fire({
                                    icon: 'success',
                                    title: 'แก้ไขข้อมูลผู้ปกครองสำเร็จ!',
                                    showConfirmButton: false,
                                    timer: 1500
                                }).then((result) => {
                                    location.reload();
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'แก้ไขข้อมูลผู้ปกครองไม่สำเร็จ!',
                                    text: 'โปรดลองอีกครั้ง',
                                    showConfirmButton: false,
                                    timer: 1500
                                })
